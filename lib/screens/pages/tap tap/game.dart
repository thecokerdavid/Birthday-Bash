...
// ! Switched to curly brackets from list brackets
// ! Switched back, but made field nullable
  ...
  Future<Offset> getNextPosition(Offset position) async {
    ...
    if (direction == Direction.right) {
      ...
      return nextPosition = Offset(position.dx, position.dy + step);
    }
